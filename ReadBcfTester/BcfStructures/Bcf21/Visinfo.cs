...
namespace Bimbot.Bcf.Bcf2
{
   ...
   public partial class ViewSetupHints
   {
      ...
      public bool SpacesVisibleSpecified
      {
         get
         {
            return this.spacesVisibleFieldSpecified;
         }
         set
         {
            this.spacesVisibleFieldSpecified = value;
         }
      }
      ...
      public bool SpaceBoundariesVisibleSpecified
      {
         get
         {
            return this.spaceBoundariesVisibleFieldSpecified;
         }
         set
         {
            this.spaceBoundariesVisibleFieldSpecified = value;
         }
      }
      ...
      public bool OpeningsVisibleSpecified
      {
         get
         {
            return this.openingsVisibleFieldSpecified;
         }
         set
         {
            this.openingsVisibleFieldSpecified = value;
         }
      }
   }
   ...
   public partial class ComponentVisibility
   {
      ...
      public bool DefaultVisibilitySpecified
      {
         get
         {
            return this.defaultVisibilityFieldSpecified;
         }
         set
         {
            this.defaultVisibilityFieldSpecified = value;
         }
      }
   }
